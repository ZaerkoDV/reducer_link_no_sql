...
public class UserController extends BaseController {
    ...
    public ResponseEntity<?> actionPostUserByIdGet(@RequestBody Map<String, Object> request) {
        User user = userService.getUserById(
            ObjUtils.asObjectId(request, "id")
        );
    ...
    public ResponseEntity<?> actionPostUserCommonUpdate(@RequestBody Map<String, Object> request) {
        return buildValidationResult(
            userService.update((new User())
                .setId(ObjUtils.asObjectId(request, "id"))
    ...
    public ResponseEntity<?> actionPostUserCommonDelete(@RequestBody Map<String, Object> request) {
        List<Link> dependentLinkList  = userService.deleteUser(ObjUtils.asObjectId(request, "id"));
    ...
    public ResponseEntity<?> actionPostUserCorespondenceCreate(@RequestBody Map<String, Object> request) {
        return buildValidationResult(
            userCorespondenceService.createUserCorespondence((new UserCorespondence())
                ...
                .setUser(new User()
                .setId(ObjUtils.asObjectId(ObjUtils.asObject(request, "user"), "id"))
    ...
    public BufferedImage actionPostUserPhotoGet(@PathVariable("idPhoto") ObjectId idPhoto) {
        return userPhotoService.getPhotoById(idPhoto);
    }

    @RequestMapping(value = "/photo/getByIdUser/{idUser}", method = RequestMethod.GET)
    public BufferedImage actionPostGetUserPhotoByIdUser(@PathVariable("idUser") ObjectId idUser) {
    ...
    public ResponseEntity<?> actionPostGetIdUserPhotoByIdUser(@PathVariable("idUser") ObjectId idUser) {
        ObjectId idUserPhoto = userPhotoService.getIdUserPhotoByIdUser(idUser);
    ...
    public ResponseEntity<?> actionPostUserPhotoCreate(@RequestParam("id") ObjectId idUser, @RequestParam("file") MultipartFile file) {
        byte[] imageFile;
